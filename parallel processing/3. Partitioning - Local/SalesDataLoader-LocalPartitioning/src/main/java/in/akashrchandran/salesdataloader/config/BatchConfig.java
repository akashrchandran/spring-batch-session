...
public class BatchConfig {
    ...
    public Step workerStep() {
        return new StepBuilder("workerStep", jobRepository)
                ...
                .reader(reader(null, null)) // Actual values will be injected at runtime
                .processor(processor())
                .writer(writer())
                .build();
    }
    ...
    public Step partitionStep() {
        return new StepBuilder("partitionStep", jobRepository)
                .partitioner("workerStep", salesDataPartitioner())
                .step(workerStep())
    ...
    @Bean
    public Job partitionSalesDataImportJob() {
